    ...
    <section id="about" className="about">
      ...
      <div className="about-grid">
        <div className="about-bio">
          <p><strong>Full-stack developer with 2 years of experience</strong> building end-to-end web applications from database architecture to polished user interfaces. I work across the entire stack — React, Node.js, TypeScript, Python, and cloud infrastructure.</p>
